<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ManageDatabase.aspx.cs" Inherits="HuMengyang0130SkySharkWebApplication.NA.Manage_Database" %>
        ...
        <div class="tabContents">
            <table>
                ...
                <tr>
                  ...
                  <tr>
                    <td colspan="3">
                        <asp:Button ID="btnUpdate" runat="server" Text="Update customer information for the frequent fliers program." BackColor="Silver" BorderColor="Blue" Font-Names="Bookman Old Style" OnClick="btnUpdate_Click" />
                      </td>
                </tr>
                </table>
            </div>
